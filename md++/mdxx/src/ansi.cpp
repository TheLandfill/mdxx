...
const char * MDXX_RESET = "\x1b[0m\x1b[39m";
const char * MDXX_RESET_COLOR = "\x1b[39m";
const char * MDXX_RESET_FORMATTING = "\x1b[39m";
...
const char * MDXX_RESET = "\033[0m\033[39m";
const char * MDXX_RESET_COLOR = "\033[39m";
const char * MDXX_RESET_FORMATTING = "\033[39m";
